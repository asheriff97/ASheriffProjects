...
player_count = int(input("How many players are there? 1-7 ")) #Need to make ability for players to cash out before game is over
...
if deck_count < 1 or deck_count > 8:
    ...
    bet_payout = 1.2
    print("Bet payout set to 1.2")
else:
    bet_payout = 1.5
    print("Bet payout set to 1.5")
...
while True:
    ...
    dealer_turn(dealer_hand, dealer_score, deck)
